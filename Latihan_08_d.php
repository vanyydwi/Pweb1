...
//Fungsi untuk membaca data dari file CVS
...
//Fungsi untuk menulis data ke file CVS
        ...
        <div class="card-body">
            ...
            <form method="post" action="">
                ...
                <div class="from-group mb-2">
                    ...
                    <input type="text" class="from-control" id="major" name="major" required>
                </div>
                <div class="from-group mb-3">
                    <label for="year">Angkatan:</label>
                    <input type="text" class="from-control" id="year" name="year" required>
                </div>
